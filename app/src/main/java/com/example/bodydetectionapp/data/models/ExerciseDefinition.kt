...
object ExerciseDefinitions {
    ...
    val CALF_RAISES = Exercise(
        name = "Calf Raises",
        description = "Raise your heels off the floor to strengthen your calves.",
        startInstruction = "Stand with your feet flat on the floor.",
        primaryMovementInstruction = "Raise your heels higher.",
        requiredLandmarks = listOf("LEFT_ANKLE", "LEFT_HEEL", "RIGHT_ANKLE", "RIGHT_HEEL"),
        visibilityFeedbackMessage = "Cannot see your feet. Please adjust the camera.",
        requiresHighPrecision = true, // This will force the app to use the full-resolution image
        type = ExerciseType.SYMMETRICAL,
        cameraView = CameraView.SIDE,
        bodyPart = BodyPart.LOWER_BODY,
        primaryMovement = AngleMovement(
            keyJointsToTrack = listOf("Left Ankle Angle", "Right Ankle Angle"),
            entryThreshold = 88.0,
            exitThreshold = 95.0
        ),
        metValue = 3.0,
        formRules = listOf(),
        videoResId = null // Add a GIF later
    )
